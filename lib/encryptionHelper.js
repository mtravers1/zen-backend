 ...
 * @returns {function(any, any, Object=): Promise<any>} A function that encrypts a provided value using the given DEK. On success returns the encrypted result; on failure logs an error block and throws an `EncryptionError` whose message contains a reportable error code.
 */
...
/**
 * Creates a decrypt helper bound to a user identifier.
 *
 * The returned function attempts to decrypt a provided value with the given DEK. If the underlying operation
 ...
 * @returns {function(value: any, dek: any, context?: object): any} A function that decrypts `value` using `dek` and optional `context`; returns the decrypted plaintext, or `null` when decryption fails due to a `DecryptionError`.
